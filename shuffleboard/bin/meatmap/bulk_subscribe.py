...
def main(meetup_api_key, groups_file, join_file):
    ...
    if groups_file:
        ...
        join_data_csv = csvwriter.build_rows(join_data)
        csvwriter.write(file=join_file,
                  data=join_data_csv)
    ...
    if meetup_api_key != 'NULL':
        ...
        join_data_result_csv = csvwriter.build_rows(join_data_result)
        csvwriter.write(file=join_result_file,
